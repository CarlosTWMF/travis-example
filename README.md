...
04 - Valide o seu arquivo .travis.yml utilizando [este link](https://lint.travis-ci.org/)




[05 - Exiba o status de Build do Travis no seu projeto do GitHub](http://stackoverflow.com/questions/19810386/showing-travis-build-status-in-github-repo)




06 - Seu projeto já está pronto para ser acompanhado. Siga as instruções a seguir para enviar os arquivos para o GitHub. Assim que você mandar os arquivos para o seu repositório já poderá visualizar o Travis trabalhando =)
